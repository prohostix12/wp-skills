  ...
  return (
    ...
    >
      ...
      <div className="absolute z-0 pointer-events-none"
        style={{ width:"700px",height:"700px",top:"-15%",right:"-5%",borderRadius:"50%",
          background:"radial-gradient(circle, rgba(88,28,255,0.18) 0%, transparent 70%)",filter:"blur(60px)" }} />
      <div className="absolute z-0 pointer-events-none"
        style={{ width:"500px",height:"500px",bottom:"-10%",left:"-5%",borderRadius:"50%",
      ...
      {/* ── Main layout ── */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 pt-36 pb-16 w-full">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div ref={headingRef}
              ...
              <span className="w-5 h-px" style={{ background:"linear-gradient(90deg,#a78bfa,#7c3aed)" }} />
            ...
            <h1 ref={headingRef}
              ...
              Build Your{" "}
              <span style={{ background:"linear-gradient(135deg,#a78bfa 0%,#7c3aed 50%,#6366f1 100%)",
            ...
            <div ref={btnRef} className="flex flex-wrap gap-3.5 mb-10">
              <a href="#contact"
                style={{ display:"inline-flex",alignItems:"center",gap:"0.5rem",padding:"0.9rem 1.8rem",
          ...
          <div className="hidden lg:flex items-center justify-center relative" style={{ height:"520px" }}>
            ...
            <div className="absolute rounded-full"
              style={{ width:"460px",height:"460px",border:"1.5px solid rgba(139,92,246,0.18)",
                top:"50%",left:"50%",transform:"translate(-50%,-50%) rotateX(70deg)" }} />
            <div className="absolute rounded-full"
              style={{ width:"360px",height:"360px",border:"1px solid rgba(99,102,241,0.12)",
                top:"50%",left:"50%",transform:"translate(-50%,-50%) rotateX(70deg)" }} />
            ...
            <div className="absolute z-20 flex items-center gap-2 px-3.5 py-2 rounded-full text-xs font-semibold text-white"
              style={{ top:"8%",right:"2%",background:"rgba(255,255,255,0.1)",
            ...
            <div className="absolute z-20 flex items-center gap-2 px-3.5 py-2 rounded-full text-xs font-semibold text-white"
              style={{ bottom:"10%",left:"20%",background:"rgba(255,255,255,0.08)",
            ...
            {orbitIcons.map(({ icon: Icon, angle }, i) => {
              ...
              return (
                <div key={i} className="absolute z-20 flex items-center justify-center rounded-xl"
                  style={{ width:"44px",height:"44px",left:`${x}%`,top:`${y}%`,
